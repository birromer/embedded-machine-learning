...
We can see here that the CART clearly has the worst results, while SVM and ANN arrive at similar precisions. The ANN can probably be better explored for different architectures, if more time was available, so to achieve better results.
